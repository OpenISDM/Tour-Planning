...
public class BetterCluster2 {
	...
	public BetterCluster2(Data data)
	{
		this.data = data;
	}
	...
	*/
	public void main(BetterCluster2 original)
	{
	...
	*/
	public void inTurnClustering()
	{
		...
		while(data.copies>0)
		{
			...
			// while all the left nodes are too far from the current salesman 
