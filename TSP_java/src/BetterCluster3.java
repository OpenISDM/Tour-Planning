...
public class BetterCluster3 {
	...
	public BetterCluster3(Data data)
	{
		this.data = data;
	...
	*/
	public void main(BetterCluster3 betterCluster)
	{
		...
		//betterCluster.inTurnClustering();
		initSales();
		determineDvalue();
		remains = data.copies;
		//System.out.println("before indexs 1 4 = "+data.indexs[1]+"  "+data.indexs[4]);
	    ...
	    //System.out.println("after indexs 1 4 = "+data.indexs[1]+"  "+data.indexs[4]);
	}
	...
	*/
	public void inTurnClustering()
	{
		...
		while(data.copies>0 && dcount<=data.SALESMAN-1)
		{
			...
			iter++;
			//System.out.println("iter lin low be == "+iter+"  dcount == "+dcount );
			for(int i=1 ; i<data.SALESMAN ; i++)
			{
				if(data.copies<1)
					break;
	...
	*/
	public void group()
	{
	    ...
	    initSalesTwo();
	    //System.out.println("after  init remaining =  "+remains);
	    ...
	    while (data.copies>0)
	    {
	    	...
	    	//System.out.println("data copies left = "+data.copies);
